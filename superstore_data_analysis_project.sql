...
-- Top 10 Products in terms of total_sales and their profit
SELECT 
	product_name, 
	category,
	sub_category,
...
-- Top 10 underperforming Products in terms of total_profit and their sales
SELECT 
	product_name, 
	category,
	sub_category,
...
-- Unique Customers with corresponding number of regions
SELECT 
...
-- Cities with lowest number of customers
SELECT 
	state,
	COUNT(DISTINCT customer_id) AS number_of_customers
FROM superstore
